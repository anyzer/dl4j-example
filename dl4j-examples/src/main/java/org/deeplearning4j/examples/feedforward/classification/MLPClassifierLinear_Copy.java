 ...
 *
 */
public class MLPClassifierLinear_Copy {
    ...
    public static void main(String[] args) throws Exception {
        ...
        rr.initialize(new FileSplit(new File("C:/Workspace/Projects/dl4j-example/dl4j-examples/src/main/resources/classification/finalSupDL_train.csv")));
        ...
        rrTest.initialize(new FileSplit(new File("C:/Workspace/Projects/dl4j-example/dl4j-examples/src/main/resources/classification/finalSupDL_eval.csv")));
